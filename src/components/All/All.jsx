    ...
    <>
      {products ?  <div className="meals mt-24 grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-20">
           {products.map(function(product, index) {
             return (
               <div key={index} className="meal text-center hover:shadow-xl group hover:scale-105 duration-300 transition-all bg-white p-12 pb-4 rounded-[35px]">
                 ...
                 <h3 className="font-semibold -mt-12 tracking-wider text-xl text-black pacifico-regular ">{product.strMeal}</h3>
                 <h5 className="flex justify-center items-center gap-2 text-emerald-600">
                 <i className="fa-solid fa-earth-americas"></i> {product.strArea}
                 </h5>
